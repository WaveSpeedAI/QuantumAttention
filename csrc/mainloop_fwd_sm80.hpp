...
template <int kNWarps, int Stages, bool Q_in_regs, class TileShape_MNK_,
          ...
          bool Is_local_, bool Has_softcap_, bool Varlen_, bool PagedKV_,
          bool AppendKV_, bool PackGQA_, bool Split_>
...
#pragma unroll 1
      ...
      //     /*is_first_iter*/, cute::bool_constant<Is_local>{} /*check_inf*/);
      // }
    }
  ...
  store_kv_new(Params const &params, int const thread_idx,
    ...
    auto n_block_new_min_max = get_n_block_k_new_min_max(
        params, seqlen_info, m_block, bidb, split_idx, params.num_splits);
