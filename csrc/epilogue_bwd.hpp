...
struct CollectiveEpilogueBwd {
  ...
  static Params to_underlying_arguments(Arguments const &args) {
    ...
    return {args.ptr_dK,  args.shape_dK,   args.stride_dK,
            args.ptr_dV,  args.stride_dV,  tma_store_dK,
            tma_store_dV, args.cu_seqlens, args.seqused};
  }
...
struct CollectiveEpilogueBwdGQA {
  ...
  store(Params const &params, FrgTensorO const &tdKrdK,
    ...
    Tensor mdVaccum =
        make_tensor(make_gmem_ptr(params.ptr_dVaccum), params.shape_dKaccum,
