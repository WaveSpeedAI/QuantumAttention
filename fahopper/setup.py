...
PACKAGE_NAME = "quantum_attn"

BASE_WHEEL_URL = "https://github.com/chengzeyi/QuantumAttention/releases/download/{tag_name}/{wheel_name}"
...
if not SKIP_CUDA_BUILD:
    ...
    sources = [os.path.join("csrc", file) for file in sources]
...
def get_package_version():
    with open(Path(this_dir) / "src" / "__init__.py", "r") as f:
...
setup(
    ...
    description="Better FP8 attention for Hopper",
