...
def early_fp8_attention_config_prune(configs, query, key, value, scale_q, scale_k):
    ...
    for config in configs:
        ...
        required_shared_memory += BLOCK_N * num_stages * scale_k.itemsize + BLOCK_M * scale_q.itemsize
...
def generate_fp8_attention_template_choices(
    ...
    *,
    ...
    query_size, key_size, value_size = (x.get_size() for x in (query, key, value))
    Lq = query_size[-1]
