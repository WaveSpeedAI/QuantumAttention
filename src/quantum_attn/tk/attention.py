...
template<int D> struct fwd_globals {
    ...
    using k_scale_row_vec = row_vec<st_fl<fwd_attend_ker_tile_dims<D>::kv_height, fwd_attend_ker_tile_dims<D>::qo_height>>;
                  ...
                  , bool causal)
{
    ...
    if (head_dim == 64) {
        ...
        using k_scale_row_vec = row_vec<st_fl<fwd_attend_ker_tile_dims<64>::kv_height, fwd_attend_ker_tile_dims<64>::qo_height>>;
        using q_scale_gl = gl<float, -1, -1, -1, -1, q_scale_col_vec>;
        using k_scale_gl = gl<float, -1, -1, -1, -1, k_scale_row_vec>;
    ...
    if (head_dim == 128) {
        ...
        using k_scale_row_vec = row_vec<st_fl<fwd_attend_ker_tile_dims<128>::kv_height, fwd_attend_ker_tile_dims<128>::qo_height>>;
        using q_scale_gl = gl<float, -1, -1, -1, -1, q_scale_col_vec>;
        using k_scale_gl = gl<float, -1, -1, -1, -1, k_scale_row_vec>;
    ...
    if (head_dim == 256) {
        ...
        using k_scale_row_vec = row_vec<st_fl<fwd_attend_ker_tile_dims<256>::kv_height, fwd_attend_ker_tile_dims<256>::qo_height>>;
        using q_scale_gl = gl<float, -1, -1, -1, -1, q_scale_col_vec>;
        using k_scale_gl = gl<float, -1, -1, -1, -1, k_scale_row_vec>;
